...
import { llmDiscoverModelsRequestSchema, llmModelsRequestSchema, llmProvidersRequestSchema, llmSubscriptionUsageRequestSchema } from '../api/llm.schema.ts'
import {
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'llm.subscriptionUsage': { schema: llmSubscriptionUsageRequestSchema, invoke: (api, r, signal) => api.llm.subscriptionUsage(r, signal) },
}
