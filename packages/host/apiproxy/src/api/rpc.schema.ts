...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('subscription-usage-failed'), message: z.string(), details: z.object({ provider: z.string() }) }),
  z.object({ code: z.literal('invalid-credential'), message: z.string(), details: z.object({ provider: z.string() }) }),
  z.object({ code: z.literal('go-subscription-required'), message: z.string(), details: z.object({ provider: z.string() }) }),
